...
-- Dashboard: https://app.supabase.com/project/rpbxeaxlaoyoqkohytlw/sql/new

-- ============================================================================
-- Populate patients table for AI chat functionality
-- ============================================================================
...
-- 3. Verify it worked
SELECT id, first_name, last_name, email, sport FROM patients;

-- Expected: 1 row showing John Brebbia
