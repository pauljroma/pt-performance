    ...
    static func sampleMilestones() -> [ProgressMilestone] {
        [
            ProgressMilestone(
                ...
                achievedDate: Calendar.current.date(byAdding: .day, value: -14, to: Date())!,
                icon: "1.circle.fill",
                color: .blue
            ),
            ProgressMilestone(
            ...
            ProgressMilestone(
                ...
                achievedDate: Calendar.current.date(byAdding: .day, value: -3, to: Date())!,
                icon: "star.fill",
                color: .orange
            )
        ]
