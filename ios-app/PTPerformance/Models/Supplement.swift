...
struct Supplement: Identifiable, Codable, Hashable {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encode(withFood, forKey: .withFood)
        try container.encodeIfPresent(notes, forKey: .notes)
        try container.encodeIfPresent(momentousProductId, forKey: .momentousProductId)
...
struct SupplementLog: Identifiable, Codable {
    ...
    func encode(to encoder: Encoder) throws {
        ...
        // Encode UUIDs as strings for Supabase compatibility
        try container.encode(id.uuidString, forKey: .id)
        try container.encode(supplementId.uuidString, forKey: .supplementId)
        try container.encode(patientId.uuidString, forKey: .patientId)
        // Encode dates as ISO8601 strings for Supabase compatibility
        try container.encode(Self.dateFormatter.string(from: takenAt), forKey: .takenAt)
        try container.encode(dosage, forKey: .dosage)
        try container.encodeIfPresent(notes, forKey: .notes)
    }
}
