...
echo "🚀 Building and uploading Build 92 to TestFlight..."
echo ""
echo "📋 Build 92: AI Chat functionality (from working build 83)"
echo ""

# Configuration
SCHEME="PTPerformance"
CONFIGURATION="Release"
ARCHIVE_PATH="./build/PTPerformance-Build92.xcarchive"
...
echo ""
echo "✅ Build 92 uploaded to TestFlight successfully!"
