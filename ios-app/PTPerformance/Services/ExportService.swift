...
class ExportService {
    ...
    func exportToPDF(sessions: [SessionWithLogs], patientName: String) async throws -> URL {
        ...
        // Create PDF document
        let pdfMetadata = [
            kCGPDFContextTitle: "PT Performance History",
            kCGPDFContextAuthor: "PT Performance",
            kCGPDFContextCreator: "PT Performance iOS App"
        ]
    ...
    private func drawPDFHeader(
        ...
        let titleText = "PT Performance History"
    ...
    private func drawPDFFooter(
        ...
        let footerText = "Generated by PT Performance on \(dateString(Date())) | Page \(pageNumber)"
