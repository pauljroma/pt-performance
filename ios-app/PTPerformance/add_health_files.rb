#!/usr/bin/env ruby
# Add Health Intelligence files to Xcode project
...
files_to_add = [
  'Extensions/Color+Modus.swift',
  'Components/Charts/BiomarkerTrendChartView.swift',
  'Models/LabAnalysis.swift',
  'Models/ParsedLabResult.swift',
  'Models/RecoveryImpactAnalysis.swift',
  'Models/SupplementRecommendation.swift',
  'Services/AICoachService.swift',
  'ViewModels/AICoachViewModel.swift',
  'Views/Health/FastingWorkoutRecommendationView.swift',
  'Views/Health/LabPDFUploadView.swift',
  'Views/Health/RecoveryInsightsView.swift',
  'Views/Health/SupplementRecommendationsView.swift',
  'Views/Health/UnifiedAICoachView.swift'
]
